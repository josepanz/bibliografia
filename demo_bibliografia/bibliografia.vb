...
Public Class bibliografia
    ...
    Dim DetalleBibliografiaID As Integer
    ...
    Private Sub btnHabilitarDetalle_Click(sender As Object, e As EventArgs) Handles btnHabilitarDetalle.Click
        ...
        EjecutarSQL("Insert into bibliografia values(@1,@2,@3)", Transac, cboLibro.SelectedValue, cboPromocion.SelectedValue, nudAnho.Value)
    ...
    Private Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        Try
            ...
            DetalleBibliografiaID = TraerValor("select max(id) from detalle_bibliografia", Transac)
            EjecutarSQL("insert into detalle_bibliografia values (@1,@2,@3)", Transac, DetalleBibliografiaID, cboLibro.SelectedValue, txtDescripcion.Text)
            ActualizarGrilla()
    ...
    Sub ActualizarGrilla()
        dgvDetalle.DataSource = generar_datatabla("select libro_id as Libro where id=" & DetalleBibliografiaID, Transac)
    End Sub
    ...
    Private Sub btnEliminar_Click(sender As Object, e As EventArgs) Handles btnEliminar.Click
        If MessageBox.Show("¿Está seguro de eliminar el Libro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
            Try
                ...
                EjecutarSQL("delete from detalle_bibliografia where id = @1 AND libro_id = @2", Transac, DetalleBibliografiaID, vLibro)
                ActualizarGrilla()
